...
var precacheConfig = [["/index.html", "c761c80288afa9b86a02b9883390fcac"], ["/static/css/main.2ee1acc1.css", "66cac42da82566374327d3b89a46d358"], ["/static/js/main.c0850e9c.js", "54a5ba75d0dd248b1929fa36dda19160"], ["/static/media/anchor.d2f8799a.svg", "d2f8799a13e6db2022d9a7de22776705"], ["/static/media/blanch_caps_inline-webfont.1461f8e9.woff", "1461f8e9d2084c70c00830348efe1766"], ["/static/media/blanch_caps_inline-webfont.73a576a8.eot", "73a576a8254aeafebcdc66fe9fd41ac8"], ["/static/media/blanch_caps_inline-webfont.7bbffda6.svg", "7bbffda6bcacac8360f0ee00bb03dc04"], ["/static/media/blanch_caps_inline-webfont.8345e1b3.ttf", "8345e1b3362c1d640f0f11b5aae1d5bc"], ["/static/media/haymaker-webfont.4c3fb584.eot", "4c3fb584d3f63821357c8a9cff97f360"], ["/static/media/haymaker-webfont.751e5627.woff", "751e56274d3ea1c651ea824f902bb987"], ["/static/media/haymaker-webfont.cf798e30.svg", "cf798e30eda73d84b25c4ae233fe5e21"], ["/static/media/haymaker-webfont.e9535f20.ttf", "e9535f20ca175cc3fdfe2816f7c47168"]],
    ...
    ignoreUrlParametersMatching = [/^utm_/], addDirectoryIndex = function (e, t) {
        ...
        var t = e[0], n = e[1], a = new URL(t, self.location), r = createCacheKey(a, hashParamName, n, /\.\w{8}\./);
        return [a.toString(), r]
    }));
...
self.addEventListener("install", function (e) {
    ...
    if ("GET" === e.request.method) {
        var t, n = stripIgnoredUrlParameters(e.request.url, ignoreUrlParametersMatching), a = "index.html";
        (t = urlsToCacheKeys.has(n)) || (n = addDirectoryIndex(n, a), t = urlsToCacheKeys.has(n));
        var r = "/index.html";
        !t && "navigate" === e.request.mode && isPathWhitelisted(["^(?!\\/__).*"], e.request.url) && (n = new URL(r, self.location).toString(), t = urlsToCacheKeys.has(n)), t && e.respondWith(caches.open(cacheName).then(function (e) {
